    ...
    <SafeAreaView>
      <View className="h-screen w-screen  align-items-center bg-gray-200 ">
        ...
        >
          ...
          >
            <Text className={` font-bold mx-auto text-TealGreen mb-6 ${isScreenSmall ? 'text-xl' : 'text-2xl'}`}>
            ...
            <Pressable
              onPress={() => Login()}
              className={`bg-TealGreen mb-4 py-4  px-4 h-max  w-24 mx-auto rounded-md ${((Platform.OS === 'web' && width<1024) || Platform.OS !=='web') ? "mt-2" : "mt-16"}`}
            >
